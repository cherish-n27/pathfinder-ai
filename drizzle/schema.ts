...
export const profiles = mysqlTable("profiles", {
  ...
  education: varchar("education", { length: 80 }),
...
export const pathways = mysqlTable("pathways", {
  ...
  recommendedDirection: text("recommendedDirection"),
...
export const opportunities = mysqlTable("opportunities", {
  id: int("id").autoincrement().primaryKey(),
  category: mysqlEnum("category", ["Study", "Work", "Skills", "Business"]).notNull(),
...
export const applications = mysqlTable("applications", {
  ...
  organisation: varchar("organisation", { length: 180 }).notNull(),
  type: mysqlEnum("type", ["Study", "Work", "Skills", "Business", "Other"]).notNull(),
  dateApplied: timestamp("dateApplied"),
  deadlineDate: timestamp("deadlineDate"),
  status: mysqlEnum("status", ["Not started", "Applied", "Interview", "Waiting", "Accepted", "Not this time", "Withdrawn"]).default("Not started").notNull(),
  notes: text("notes"),
  linkedPathwayId: int("linkedPathwayId"),
